...
#SBATCH -J mae_curriculum   # Job name
...
mkdir -p /dss/dsshome1/02/ge62rob3/mae/output_curriculum_cumulative_mae_30epoch_fixiou_patch_run2

# Run the curriculum learning script
python main_curriculum_mae_bw_fixiou_patch.py \
    --epochs_per_stage 30 \
    --batch_size 64 \
    --model mae_vit_base_patch16_bw \
    --mask_ratio 0.25 \
    --data_path /dss/dsshome1/02/ge62rob3/mae/dataset_imagenet_style \
    --output_dir /dss/dsshome1/02/ge62rob3/mae/output_curriculum_cumulative_mae_30epoch_fixiou_patch_run2 \
    --blr 1.5e-4 \
    --weight_decay 0.05 \
    --warmup_epochs 10 \
    --device cuda \
    --num_workers 48 \
    2>&1 | tee -a /dss/dsshome1/02/ge62rob3/mae/output_curriculum_cumulative_mae_30epoch_fixiou_patch_run2/training_main_curriculum_mae_bw_fixiou_patch.log 
